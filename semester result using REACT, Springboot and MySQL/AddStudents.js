        ...
        <div className="flexSignup">
          ...
          <div>
            ...
            <input
              placeholder="ESE"
              value={cde}
              onChange={(e) => setcde(e.target.value)}
            />
          </div>
        </div>
        <div className="flexSignup">
        ...
        <div className="flexSignup">
          ...
          <div>
            <input
              placeholder="MSE"
              value={wtm}
              onChange={(e) => setwtm(e.target.value)}
            />
            <input
              placeholder="ESE"
              value={wte}
        ...
        <div className="flexSignup">
          ...
          <div>
            ...
            <input
              placeholder="ESE"
              value={daae}
              onChange={(e) => setdaae(e.target.value)}
            />
          </div>
        </div>
      </section>
      <div>
        <button className="button-10 btn" onClick={submit}>
          Submit
        </button>
      </div>
    </div>
